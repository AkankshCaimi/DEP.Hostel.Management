...
export default function Allotment() {
  const [nodes, setNodes, onNodesChange] = useNodesState([
    {
      ...
      type: "custom",
      position: { x: 50, y: 50 },
      data: { label: "Btech 21", test: 50 },
      sourcePosition: "right",
      style: { ".port": { width: "20px", height: "20px" } },
    },
    {
      id: "7",
      type: "hostel",
      data: { label: "Chenab", capacity: 500, unallocated: 120 },
      position: { x: 600, y: 50 },
      targetPosition: "left",
    },
    {
      id: "8",
      type: "hostel",
      data: { label: "Satluj", capacity: 400, unallocated: 120 },
    ...
    },
    {
      id: "9",
      type: "hostel",
      data: { label: "Beas", capacity: 400, unallocated: 120 },
    ...
    },
    {
      id: "10",
      type: "hostel",
      data: { label: "Brahmaputra Boys", capacity: 600, unallocated: 120 },
    ...
    },
    {
      id: "11",
      type: "hostel",
      data: { label: "T6", capacity: 300, unallocated: 120 },
  ...
  const onConnect = useCallback(
    (params) => {
      const value = prompt(
        "Enter the number of students you want to put in hostel "
      );
      if (value < 40) {
      ...
      <>
        <Tabs value="html" className="pb-0 mb-0">
          <TabsHeader>
            ...
            <Button onClick={Opendialoge} className="z-10 w-2/5 py-0 px-2">
              Add Batch
            </Button>
          </TabsHeader>
        </Tabs>
        ...
        >
          ...
          >
            ...
            <Controls
              style={{ position: "absolute", bottom: 120, left: 10 }}
  ...
  <div className="text-gray-700 text-lg text-center p-8 my-60">
    <p>Please view this content on a desktop.</p>
  </div>
</div>
